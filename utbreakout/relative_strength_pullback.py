...
def default_relative_strength_pullback_config():
    return {
        ...
        # Use square-root volatility scaling.  Full inverse-vol scaling was
        # repeatedly shrinking an otherwise valid pullback a second time after
        # market-quality and L2 sizing had already expressed the same risk.
