...
EV_ADAPTIVE_PROFILE_VERSION = "ev_adaptive_v2"
...
def default_ev_adaptive_config():
    return {
        ...
        "continuation_max_signal_age_bars": 10.0,
        "continuation_reacceleration_range_min": 1.05,
        "continuation_reacceleration_volume_min": 0.80,
...
def _profile(mode):
    if mode == "STRONG_TREND":
        return EvExitProfile(
            ...
            tp2_ratio=0.35,
            runner_ratio=0.45,
            trailing_activation_r=1.30,
            trailing_atr_multiplier=3.20,
    ...
    return EvExitProfile(
        ...
        trailing_atr_multiplier=2.70,
        single_target_r=1.60,
        time_stop_bars=8,
    )
