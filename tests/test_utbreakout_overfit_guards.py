...
def test_ev_adaptive_final_overrides_are_authoritative():
...
def test_ev_profile_can_disable_the_legacy_final_risk_floor():
    cfg = {"final_risk_multiplier_floor": 0.0}

    assert _apply_utbreakout_risk_multiplier_floor(0.016, cfg) == 0.016
