...
_DURABLE_ENTRY_PLAN_KEYS = (
    ...
    'small_account_aggressive_full_target_loss_usdt',
    'small_account_aggressive_full_target_loss_percent',
    ...
    'small_account_pullback_resumption',
    'small_account_pullback_recovery_confirmed',
    'small_account_impulse_breakout',
    'change_point_flow_profile',
    'change_point_flow_state',
    'change_point_flow_code',
    'change_point_flow_total_score',
    'change_point_flow_price_score',
    ...
    'change_point_flow_soft_veto_override',
    'independent_event_context_profile',
    'independent_event_context_broad_side',
    'independent_event_context_weighted_momentum',
    'independent_event_context_dominant_votes',
    'independent_event_context_minimum_votes',
    'independent_event_context_broad_conflict_min_momentum',
    'independent_event_context_fast_ema_distance_atr',
    'independent_event_context_max_fast_ema_distance_atr',
    'independent_event_risk_tier_cap',
    'independent_event_risk_tier_capped',
    'trend_event_candidate_source',
    'trend_event_candidate_agreement',
    'trend_event_candidate_score',
    'trend_event_trend_score',
    'trend_event_event_score',
    ...
    'pyramid_add_count',
    'adaptive_trend_pyramid_enabled',
    'adaptive_trend_pyramid_trigger_r',
    'adaptive_trend_pyramid_target_fractions',
    'adaptive_trend_pyramid_add_count',
    'adaptive_trend_target_qty',
    'adaptive_trend_target_risk_usdt',
    'adaptive_trend_target_notional',
    'adaptive_trend_initial_fraction',
    'adaptive_trend_initial_entry_price',
    'adaptive_trend_initial_risk_distance',
    'adaptive_trend_partial_r_multiple',
    'adaptive_trend_partial_ratio',
    'adaptive_regime_engine',
    'adaptive_regime_profile',
    'adaptive_regime_selected_net_edge',
    'adaptive_regime_primary_net_edge',
    'adaptive_regime_reversal_net_edge',
    ...
    'small_account_evidence_allocation_applied',
    ...
    'adaptive_breakout_trend_target_risk_percent',
    'convex_rotation_score',
    'convex_rotation_percentile',
    'convex_rotation_rank',
    'convex_rotation_universe_size',
    'convex_rotation_tier',
    'convex_rotation_profile',
    'adaptive_trend_absolute_risk_tier',
    'tradfi_relative_rank_upgrade_only',
    'tradfi_absolute_tier_floor_applied',
    'convex_rotation_entry_reacceleration',
    'convex_rotation_exit_enabled',
    'convex_rotation_min_holding_bars',
    'convex_rotation_max_holding_bars',
    'convex_rotation_max_mfe_r',
    'convex_rotation_max_current_r',
    'convex_rotation_rank_percentile_floor',
    'convex_rotation_rank_confirmations',
    'risk_budget_mode',
    'trend_health_score',
