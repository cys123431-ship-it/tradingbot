...
MA_STRATEGIES = set()
PATTERN_STRATEGIES = set(UT_ONLY_STRATEGIES) | {EMA200_UTBOT_RSI_STRATEGY}
CORE_STRATEGIES = set(UT_ONLY_STRATEGIES) | {EMA200_UTBOT_RSI_STRATEGY} | UTBREAKOUT_STRATEGIES
...
STRATEGY_DISPLAY_NAMES = {
    ...
    'utrsi': 'UTRSI',
    'utbb': 'UTBB',
    EMA200_UTBOT_RSI_STRATEGY: 'EMA200 + UT Bot + RSI (2H)',
    UTBOT_FILTERED_BREAKOUT_STRATEGY: 'UTBOT_FILTERED_BREAKOUT_V1',
    UTBOT_ADAPTIVE_TIMEFRAME_STRATEGY: 'UTBOT_ADAPTIVE_TIMEFRAME_V1',
    ENTRY_STRATEGY_RELATIVE_STRENGTH_PULLBACK_TREND: 'RELATIVE_STRENGTH_PULLBACK_TREND',
    QH_FLOW_STRATEGY: 'QH_FLOW',
    VOLATILITY_MANAGED_TREND_STRATEGY: 'VOLATILITY_MANAGED_TREND',
    ...
    ADAPTIVE_BREAKOUT_TREND_STRATEGY: 'ADAPTIVE_BREAKOUT_TREND',
}
...
QUAD_ALPHA_BRANCH_LABELS = {
    ...
    VOLATILITY_MANAGED_TREND_STRATEGY: 'VMT Trend',
...
QUAD_ALPHA_SELECTOR_KEYS = {
    ...
    'vmt': VOLATILITY_MANAGED_TREND_STRATEGY,
...
def normalize_quad_alpha_enabled_strategies(value):
    ...
    aliases = {
        **QUAD_ALPHA_SELECTOR_KEYS,
        ...
        'vmttrend': VOLATILITY_MANAGED_TREND_STRATEGY,
        'volatility_managed_trend': VOLATILITY_MANAGED_TREND_STRATEGY,
        # Migrate stale Telegram keyboards and persisted QH selections to VMT.
        'qh': VOLATILITY_MANAGED_TREND_STRATEGY,
        'qhflow': VOLATILITY_MANAGED_TREND_STRATEGY,
        QH_FLOW_STRATEGY: VOLATILITY_MANAGED_TREND_STRATEGY,
