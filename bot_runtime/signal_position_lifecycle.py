...
class SignalPositionLifecycleMixin:
    ...
    def _register_utbreakout_trailing_state(self, symbol, side, entry_price, qty, plan, cfg):
        ...
        state = {
            ...
            'opportunity_risk_multiplier': plan.get('opportunity_risk_multiplier'),
            'opportunity_risk_tier': plan.get('opportunity_risk_tier'),
            'opportunity_risk_reason': plan.get('opportunity_risk_reason'),
            ...
            'convex_rotation_score': _safe_float_or_none(plan.get('convex_rotation_score')),
            'convex_rotation_entry_percentile': _safe_float_or_none(plan.get('convex_rotation_percentile')),
            'convex_rotation_current_percentile': _safe_float_or_none(plan.get('convex_rotation_percentile')),
            ...
            'convex_rotation_max_holding_bars': int(plan.get('convex_rotation_max_holding_bars', 48) or 48),
            'convex_rotation_max_mfe_r': float(plan.get('convex_rotation_max_mfe_r', 0.35) or 0.35),
            'convex_rotation_max_current_r': float(plan.get('convex_rotation_max_current_r', 0.25) or 0.25),
            'convex_rotation_rank_percentile_floor': float(plan.get('convex_rotation_rank_percentile_floor', 35.0) or 35.0),
            'convex_rotation_rank_confirmations': int(plan.get('convex_rotation_rank_confirmations', 2) or 2),
            'convex_rotation_bad_rank_count': 0,
            'convex_rotation_last_rank_hour': None,
            'risk_budget_mode': plan.get('risk_budget_mode'),
            'small_account_aggressive_active': bool(plan.get('small_account_aggressive_active', False)),
            'small_account_aggressive_reason': plan.get('small_account_aggressive_reason'),
            'small_account_target_margin_usdt': _safe_float_or_none(plan.get('small_account_target_margin_usdt')),
            'small_account_aggressive_initial_margin_usdt': _safe_float_or_none(plan.get('small_account_aggressive_initial_margin_usdt')),
            'small_account_aggressive_max_loss_percent': _safe_float_or_none(plan.get('small_account_aggressive_max_loss_percent')),
            'small_account_aggressive_max_loss_usdt': _safe_float_or_none(plan.get('small_account_aggressive_max_loss_usdt')),
            'small_account_aggressive_daily_loss_limit_percent': _safe_float_or_none(plan.get('small_account_aggressive_daily_loss_limit_percent')),
            'small_account_aggressive_daily_loss_limit_usdt': _safe_float_or_none(plan.get('small_account_aggressive_daily_loss_limit_usdt')),
            'small_account_aggressive_projected_loss_usdt': _safe_float_or_none(plan.get('small_account_aggressive_projected_loss_usdt')),
            ...
            'small_account_aggressive_full_target_loss_usdt': _safe_float_or_none(plan.get('small_account_aggressive_full_target_loss_usdt')),
            'small_account_aggressive_full_target_loss_percent': _safe_float_or_none(plan.get('small_account_aggressive_full_target_loss_percent')),
