...
OPPORTUNITY_OVERRIDES = {
    ...
    "quad_alpha_single_signal_risk_multiplier": 0.65,
    "quad_alpha_two_signal_risk_multiplier": 0.85,
    "quad_alpha_three_signal_risk_multiplier": 0.95,
    ...
    "profit_alpha_default_follow_through_bars": 5,
    "profit_alpha_default_follow_through_min_mfe_r": 0.30,
    ...
    "runner_chandelier_multiplier": 3.25,
